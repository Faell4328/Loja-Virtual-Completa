...
recoveryPasswordRoute.post('/recuperacao/senha', regularlCondicionalRoutes, emailLimit, isNotLogged, validateEmail, (req: Request, res: Response) => {
    passwordRecoveryController(req, res);
    return;
});

recoveryPasswordRoute.get('/recuperacao/senha/:hash', regularlCondicionalRoutes, confirmationLimit, isNotLogged, (req: Request, res: Response) => {
    checkTokenPasswordRecoveryController(req, res);
    return;
})

recoveryPasswordRoute.put('/recuperacao/senha/:hash', regularlCondicionalRoutes, confirmationLimit, isNotLogged, validatePassword, (req: Request, res: Response) => {
